...
"""
__author__ = "Maria Garcia de la Banda for the base"+" Tee Zhi Hui for documentation - complexity"
...
class ArrayStack(Stack[T]):
    ...
    def __init__(self, max_capacity: int) -> None:
        ...
        :complexity: Best O(length), where length is the max(1, max_capacity) 
                     Worst O(length), where length is the max(1, max_capacity) 
        """
        Stack.__init__(self)
